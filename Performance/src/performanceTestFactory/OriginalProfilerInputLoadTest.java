...
/**
 * 
 * Performance load test of Profiler. Load process. 
 *
 */
public class OriginalProfilerInputLoadTest extends LoadProfilerTest {
	...
	public OriginalProfilerInputLoadTest() {
		super();
		System.out.println("--- PROFLER VERSION ORIGINAL. PRUEBA DE CARGA. ENTRADA ---");
	}
